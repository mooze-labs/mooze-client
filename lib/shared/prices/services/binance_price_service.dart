...
class BinancePriceService extends PriceService {
  ...
  BinancePriceService(Currency defaultCurrency)
  ...
  TaskEither<String, Option<double>> getCoinPrice(
    ...
    final currency =
        (optionalCurrency == null) ? _defaultCurrency : optionalCurrency;
...
class BinanceDailyPriceVariationService extends DailyPriceVariationService {
  ...
  BinanceDailyPriceVariationService(Currency defaultCurrency)
    : _defaultCurrency = defaultCurrency;
        ...
        .map(
          (fetched) => fetched
              ...
              .fold(
                () => 0.0,
                (info) => info
                    .extract("priceChangePercent")
                    .fold(() => 0.0, (n) => double.tryParse(n) ?? 0.0),
              ),
        );
  ...
  TaskEither<String, List<double>> get24hrKlines(
    ...
    if (asset == Asset.depix && currency == Currency.usd) {
      return _get24hrKlinesForSymbol(
        "USDTBRL",
