...
final feeRateProvider = FutureProvider.autoDispose.family<double, double>((ref, depositAmount) async {
  double feeRate;
...
// Family provider that takes deposit amount as parameter
final feeAmountProvider = FutureProvider.autoDispose.family<double, double>((ref, depositAmount) async {
...
// Family provider that takes deposit amount as parameter
final discountedFeesDepositProvider = FutureProvider.autoDispose.family<double, double>((ref, depositAmount) async {
