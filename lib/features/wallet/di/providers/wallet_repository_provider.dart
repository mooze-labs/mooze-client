...
final walletRepositoryProvider = FutureProvider<Either<WalletError, WalletRepository>>((ref) async {
  final breez = await ref.read(breezClientProvider.future);

  return breez.fold(
      (err) => Either.left(WalletError(WalletErrorType.networkError, "Failed to instantiate Breez client: $err")),
