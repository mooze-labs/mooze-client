...
WolletRepository bitcoinWolletRepository(Ref ref) {
  return BitcoinWolletRepository(
...
@Riverpod(keepAlive: true)
SignerRepository bitcoinSignerRepository(Ref ref) {
  return BitcoinSignerRepository(
