...
class ComponentThemes {
  ...
  /// App Bar Theme
  static AppBarTheme appBarTheme(BuildContext context, ColorScheme colorScheme) => AppBarTheme(
  ...
  static InputDecorationTheme get legacyInputDecorationTheme => InputDecorationTheme(
    border: OutlineInputBorder(
  ...
  static ElevatedButtonThemeData elevatedButtonTheme(BuildContext context, ColorScheme colorScheme) => 
  ...
  static DividerThemeData get dividerTheme => const DividerThemeData(
    color: AppColors.swapLinearBorder,
    thickness: 1,
  );
